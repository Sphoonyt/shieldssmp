...
public class GlobalListener implements Listener {
    ...
    public void onEntityDamageByEntity(EntityDamageByEntityEvent event) {
        ...
        if (event.getDamager() instanceof Player attacker) {
            ...
            if (event.getEntity() instanceof org.bukkit.entity.LivingEntity le) {
                ...
                // Blood: Crimson Frenzy – increase outgoing damage by 0% (no buff here,
                // strength potion already applied by the ult)
                // Blink: True Invis – 1.5x outgoing damage
        ...
        if (event.getEntity() instanceof Player victim) {
            ...
            // Combustion: only block explosions from their OWN abilities (TNT with their metadata)
    ...
    public void onExplosion(EntityDamageEvent event) {
        ...
        // Super Supernova fall damage cancel
        if (event.getCause() == EntityDamageEvent.DamageCause.FALL) {
            PlayerClass cls2 = cm.getPlayerClass(p.getUniqueId());
            if (cls2 instanceof com.shieldssmp.classes.impl.SuperClass sc && sc.cancelFallDamage(p.getUniqueId())) {
        ...
        if (cls instanceof TerroristClass && isCombustionOwnExplosion(event)) {
            event.setCancelled(true);
        }
    ...
    public void onEntityTarget(EntityTargetLivingEntityEvent event) {
        ...
        // Check if the attacker is one of the owner's minions
        ...
        // Also prevent any mob targeting a player with Boss Sovereign passive
        if (cls instanceof com.shieldssmp.classes.impl.BossClass) {
            // Block non-player mobs targeting the Boss player
